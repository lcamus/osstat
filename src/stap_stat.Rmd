...
if (!exists("d")) load("data/os-visits+actions_2017-10-02_2018-04-15.RData")
...
data <- data[data$date>="2018-01-01" & data$date<="2018-03-31",]
...
data <- d[["VisitsSummary"]][["get"]]
data <- data[order(data$date),]
data <- data[data$date>="2017-10-02" & data$date<="2018-03-31",]
data$nb_visits <- as.numeric(data$nb_visits)
...
p_a <- clean(begin="2018-01-01", end="2018-03-31",agreg=T)
